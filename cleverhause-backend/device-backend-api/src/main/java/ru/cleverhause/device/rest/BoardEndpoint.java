package ru.cleverhause.device.rest;
...
import ru.cleverhause.device.dto.DeviceSetting;
import ru.cleverhause.device.dto.DeviceStructure;
import ru.cleverhause.device.dto.request.BoardRequestBody;
import ru.cleverhause.device.dto.response.OutputBoard;
import ru.cleverhause.device.dto.response.ResponseBody;
